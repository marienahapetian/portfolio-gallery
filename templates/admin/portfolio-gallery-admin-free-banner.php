...
<div class="free_version_banner" <?php if( isset($_COOKIE['hgSliderFreeBannerShow']) && isset($_COOKIE['hgSliderFreeBannerShow']) == "no" ){ echo 'style="display:none"'; } ?> >
    ...
    <img class="manual_icon" src="<?php echo PORTFOLIO_GALLERY_IMAGES_URL.'/admin_images/icon-user-manual.png';?>" alt="user manual" />
    ...
    <a href="http://huge-it.com" target="_blank"><img class="huge_it_logo" src="<?php echo PORTFOLIO_GALLERY_IMAGES_URL.'/admin_images/Huge-It-logo.png'; ?>"/></a>
    ...
    <div class="hg_view_plugins_block">
        <a target="_blank"  href="https://wordpress.org/support/view/plugin-reviews/portfolio-gallery">Rate Us</a>
