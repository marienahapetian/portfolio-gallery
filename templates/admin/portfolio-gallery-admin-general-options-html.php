				...
				<div id="portfolio-options-list">
					...
					<ul class="options-block" id="portfolio-view-tabs-contents">
						...
						<div class="has-background">
							<label for="port_natural_size_blockstoggle"><?php //echo __( "Element's Image Behaviour", 'portfolio-gallery' );?></label>
							<select id="port_natural_size_blockstoggle" name="params[port_natural_size_blockstoggle]">
							  <option <?php //if($param_values['port_natural_size_blockstoggle'] == 'resize'){ echo 'selected="selected"'; } ?> value="resize"><?php //echo __( 'Resize', 'portfolio-gallery' );?></option>
							  <option <?php //if($param_values['port_natural_size_blockstoggle'] == 'natural'){ echo 'selected="selected"'; } ?> value="natural"><?php //echo __( 'Natural', 'portfolio-gallery' );?></option>
							</select>
						</div>
						-->
								<div>
