...
.portelement_<?php echo $portfolioID; ?> {
    ...
    <?php if(isset($portfolio_gallery_get_options['portfolio_gallery_ht_view0_element_box_shadow']) && $portfolio_gallery_get_options['portfolio_gallery_ht_view0_element_box_shadow']=='on' ):?>box-shadow: 0px 1px 3px 0px rgba(0, 0, 0, 0.17);<?php endif;?>
}
...
.variable-sizes .portelement_<?php echo $portfolioID; ?>.large.width2.height2 {
    ...
    width: 100%;
    z-index: 10;
    box-shadow: 0px 3px 9.8px 0.2px rgba(0, 0, 0, 0.16);
}
...
.portelement_<?php echo $portfolioID; ?> .title-block_<?php echo $portfolioID; ?> .open-close-button {
    ...
    top:50%;
    right:2%;
<?php if($portfolio_gallery_get_options['portfolio_gallery_ht_view0_togglebutton_style']=='dark'){
    echo "background: #303030; color: #fff;";
} else {
    echo "color: #303030;";
}?>
    z-index:5;
...
.portelement_<?php echo $portfolioID; ?>:hover .title-block_<?php echo $portfolioID; ?> .open-close-button {
    opacity:1;
}

.portelement_<?php echo $portfolioID; ?>.large .open-close-button>svg {
...
.wd-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?>,
.portelement_<?php echo $portfolioID; ?> div.right-block .description-block_<?php echo $portfolioID; ?> * {
    position:relative;
    clear:both;
}
...
.wd-portfolio-panel_<?php echo $portfolioID; ?> .thumbs-list_<?php echo $portfolioID; ?> li a {
    ...
    height: <?php echo 3/4*$portfolio_gallery_get_options['portfolio_gallery_ht_view0_thumbs_width'];?>px;
    opacity: 0.7;
    display: table;
...
.wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a,
.wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:link,
.wd-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:visited {
    padding: 6px 12px ;
...
<?php   if($sortingFloatToggle != 'top'){
        ...
        if($filteringFloatToggle == 'top') echo 'margin-top: 57px;';
        if($sortingFloatToggle == 'left') echo 'margin-right: 2%;';
        ...
        if($filteringFloatToggle == 'left') echo 'margin-left: calc(21% + 5px);';else echo 'margin-left:5px;';
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> #huge_it_portfolio_options_<?php echo $portfolioID; ?> ul li a {
    ...
    margin: 0 !important;
    display: block;
    padding: <?php echo $portfolio_gallery_get_options["portfolio_gallery_ht_view0_sortbutton_border_padding"];?>px <?php echo 2*$portfolio_gallery_get_options["portfolio_gallery_ht_view0_sortbutton_border_padding"];?>px;
    border-radius: 3px;
}
...
<?php   if($filteringFloatToggle != 'top'){
            ...
            echo  "max-width:180px; width:19%; display:inline-block;";
            if($filteringFloatToggle == 'left') echo 'margin-right: 2%;';
            else echo 'margin-left:2%;';
        }
        else {
            if($portfolioposition == 'on' && ($sortingFloatToggle == 'top' || $sortingFloatToggle == '')) echo 'left:50%; transform:translateX(-50%);';
            if($sortingFloatToggle == 'left') echo 'margin-left: calc(21% + 5px);';
            else echo 'margin-left:5px;';
            echo 'width: auto; margin-bottom: 10px; display:table;';
        }
        if(($sortingFloatToggle == 'left' && $filteringFloatToggle == 'left') || ($sortingFloatToggle == 'right' && $filteringFloatToggle == 'right')){
            echo 'width: 100%;';
        }
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> #huge_it_portfolio_filters_<?php echo $portfolioID; ?> ul li {
    ...
    margin-left: 0;
<?php
    if($filteringFloatToggle == "top") { echo "float:left !important; margin: 0 8px 0 0 !important;"; }
?>
}
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> #huge_it_portfolio_filters_<?php echo $portfolioID; ?> ul li a:visited {
    ...
    border-radius: <?php echo $portfolio_gallery_get_options["portfolio_gallery_ht_view0_filterbutton_border_radius"];?>px;
    padding: <?php echo $portfolio_gallery_get_options["portfolio_gallery_ht_view0_filterbutton_border_padding"];?>px <?php echo 2*$portfolio_gallery_get_options["portfolio_gallery_ht_view0_filterbutton_border_padding"];?>px;
    display: block;
    text-decoration: none;
}
