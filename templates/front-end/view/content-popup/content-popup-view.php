                        ...
                        switch (portfolio_gallery_youtube_or_vimeo_portfolio($imgurl[0])) {
                            case 'image': ?>
                                <img alt="<?php echo $row->name; ?>" id="wd-cl-img<?php echo $key; ?>"
                                     src="<?php echo esc_url( get_image_by_sizes_and_src( $imgurl[0], $paramssld['ht_view2_element_width'] ) ); ?>"/>
                                <?php
                                break;
                            case 'youtube':
                                            ...
                                            case 'image':
                                                ...
                                                <a href="<?php echo esc_url( $img ); ?>"
                                                   ...
                                                   title="<?php echo esc_attr($row->name); ?>"><img
                                                        src="<?php echo esc_url( get_image_by_sizes_and_src( $img, array( $paramssld['ht_view2_thumbs_width'], $paramssld['ht_view2_thumbs_height'] ) ) ); ?>"></a>
