						...
						switch ( portfolio_gallery_youtube_or_vimeo_portfolio( $imgurl[0] ) ) {
							case 'image':
								...
								<a class="portfolio-group<?php echo $group_key1; ?> portfolio-group-slider_<?php echo $portfolioID; ?>_<?php echo $group_key1; ?>"
								   ...
								   title="<?php echo esc_attr( $row->name ); ?>" data-groupID="<?php echo $group_key1;?>"><img
							...
							case 'youtube':
								...
								<a href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>"
								   ...
								   title="<?php echo esc_attr( $row->name ); ?>" data-groupID="<?php echo $group_key1;?>">
							...
							case 'vimeo':
								...
								<a class="portfolio-group<?php echo $group_key1; ?> huge_it_portfolio_item pvimeo portfolio-group-slider_<?php echo $portfolioID; ?>_<?php echo $group_key1; ?>   add-H-relative add-H-block"
								   ...
								   title="<?php echo $row->name; ?>" data-groupID="<?php echo $group_key1;?>">
								...
								foreach ( $imgurl as $key => $img ) {
									switch ( portfolio_gallery_youtube_or_vimeo_portfolio( $img ) ) {
										case 'image':
											...
											<li>
												<a class="portfolio-group<?php echo $group_key1; ?> portfolio-group-slider_<?php echo $portfolioID; ?>_<?php echo $group_key1; ?>"
												   href="<?php echo esc_url( $img ); ?>" data-groupID="<?php echo $group_key1;?>"><img
										...
										case 'youtube':
											...
											<li>
												<a href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>"
												   class="portfolio-group<?php echo $group_key1; ?> huge_it_portfolio_item pyoutube portfolio-group-slider_<?php echo $portfolioID; ?>_<?php echo $group_key1; ?>  add-H-relative" data-groupID="<?php echo $group_key1;?>">
													<img
														src="//img.youtube.com/vi/<?php echo $videourl[0]; ?>/mqdefault.jpg">
													<div
										...
										case 'vimeo':
											...
											<li>
												<a class="portfolio-group<?php echo $group_key1; ?> huge_it_portfolio_item pvimeo portfolio-group-slider_<?php echo $portfolioID; ?>_<?php echo $group_key1; ?>  add-H-relative"
												   ...
												   style="position:relative" data-groupID="<?php echo $group_key1;?>">
