...
.title-block_<?php echo esc_html($portfolioID); ?> {
    position:relative;
    display:block;
    height:45px;
...
.title-block_<?php echo esc_html($portfolioID); ?> h3 {
    position:relative;
...
.wd-portfolio-panel_<?php echo esc_html($portfolioID); ?> .description-block_<?php echo esc_html($portfolioID); ?> p,.portelement_<?php echo esc_html($portfolioID); ?> div.right-block .description-block_<?php echo esc_html($portfolioID); ?> * {
    text-align:justify;
