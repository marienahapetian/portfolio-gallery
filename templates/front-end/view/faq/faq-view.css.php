...
.portelement_<?php echo $portfolioID; ?> {
    ...
    <?php if(isset($portfolio_gallery_get_options['portfolio_gallery_ht_view4_element_box_shadow']) && $portfolio_gallery_get_options['portfolio_gallery_ht_view4_element_box_shadow'] == 'on') {?>box-shadow: 0px 2px 2.82px 0.18px rgba(1, 1, 1, 0.15);<?php } ?>
}
...
.portelement_<?php echo $portfolioID; ?> .title-block_<?php echo $portfolioID; ?> .open-close-button {
    ...
    opacity: 0.33;
    padding: 1px 2px;
<?php if($portfolio_gallery_get_options['portfolio_gallery_ht_view4_togglebutton_style']=='dark'){
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> #huge_it_portfolio_options_<?php echo $portfolioID; ?> {
    ...
    padding: 13px;
    border-radius: 3px;
    box-shadow: 0px 2px 2.82px 0.18px rgba(1, 1, 1, 0.15);
<?php   if($sortingFloatFaq != 'top'){
            ...
            if($sortingFloatFaq == 'left') echo 'margin-right: 2%;';
            ...
            if($filteringFloatFaq == 'left') echo 'margin-left: calc(21% + 5px);';else echo 'margin-left:5px;';
...
<?php
    ...
    { echo "float:left !important;margin: 0px 8px 0 0px !important;"; }
?>
}
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> #huge_it_portfolio_options_<?php echo $portfolioID; ?> ul li a {
    ...
    display: block;
    border-radius: <?php echo $portfolio_gallery_get_options["portfolio_gallery_ht_view4_sortbutton_border_radius"];?>px;
    padding: <?php echo $portfolio_gallery_get_options["portfolio_gallery_ht_view4_sortbutton_border_padding"];?>px <?php echo 2*$portfolio_gallery_get_options["portfolio_gallery_ht_view4_sortbutton_border_padding"];?>px;
}
...
<?php   if($filteringFloatFaq != 'top'){
            ...
            echo  "max-width:180px; width:19%; display:inline-block;";
            if($filteringFloatFaq == 'left') echo 'margin-right: 2%;';
            else echo 'margin-left:2%;';
        }
        else {
            if($portfolioposition == 'on' && ($sortingFloatFaq == 'top' || $sortingFloatFaq == '')) echo 'left:50%; transform:translateX(-50%);';
            if($sortingFloatFaq == 'left') echo 'margin-left: calc(21% + 5px);'; else echo 'margin-left:5px;';
            echo 'width: auto; margin-bottom: 5px; display:table;';
        }
        if(($sortingFloatFaq == 'left' && $filteringFloatFaq == 'left') || ($sortingFloatFaq == 'right' && $filteringFloatFaq == 'right')){
            echo 'width: 100%;';
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> #huge_it_portfolio_filters_<?php echo $portfolioID; ?> ul li {
    ...
    margin-left: 0;
<?php
    if($filteringFloatFaq == "top") { echo "float:left !important;margin: 0px 8px 0 0px !important;"; }
?>
}
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> #huge_it_portfolio_filters_<?php echo $portfolioID; ?> ul li a {
    ...
    border-radius: <?php echo $portfolio_gallery_get_options["portfolio_gallery_ht_view4_filterbutton_border_radius"];?>px;
    padding: <?php echo $portfolio_gallery_get_options["portfolio_gallery_ht_view4_filterbutton_border_padding"];?>px <?php echo 2*$portfolio_gallery_get_options["portfolio_gallery_ht_view4_filterbutton_border_padding"];?>px;
    display: block;
    text-decoration: none;
}
