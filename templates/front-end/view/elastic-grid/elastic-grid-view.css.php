...
#huge_it_portfolio_container_<?php echo $portfolioID; ?>  ul#portfolio-filter a {
	...
	color: #<?php echo $portfolio_gallery_get_options['portfolio_gallery_ht_view7_filter_button_font_color']; ?>;
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> .wagwep-container {
	<?php if ( $portfolioShowFiltering != 'on' ): ?>
	display: none;
	<?php endif; ?>
}
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-grid > li {
	...
	<?php $margin = $portfolio_gallery_get_options['portfolio_gallery_ht_view7_element_margin']; ?>
	margin: <?php echo $margin; ?>px <?php echo $margin/2; ?>px 0 <?php echo $margin/2; ?>px;
}
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-grid li > a >img {
	<?php if( $portfolio_gallery_get_options['portfolio_gallery_ht_view7_image_behaviour'] == 'resize'): ?>
	width: 100%;
	height: 100%;
	<?php endif;?>
    max-width: none;
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-expander .elastislide-wrapper {
	...
	<?php if( $portfolio_gallery_get_options['portfolio_gallery_ht_view7_thumbnail_block_box_shadow'] == 'on'): ?>
...
#huge_it_portfolio_content_<?php echo $portfolioID; ?> .og-expander ul.elastislide-list li > a > img {
	...
	max-width: none;
	max-height: none;
	border: 2px solid #<?php echo $portfolio_gallery_get_options['portfolio_gallery_ht_view7_thumbnail_bg_color']; ?>;
}
