...
function portfolio_gallery_print_html_nav($count_items,$page_number,$search_fields = ''){
	if ( $count_items ) {
		if ( $count_items % 20 ) {
    ...
    <?php if ( $search_fields != "" ) echo $search_fields; ?>
    ...
    <input type="hidden" id="page_number" name="page_number" value="<?php echo isset($_POST['page_number']) ? absint($_POST['page_number']) : 1; ?>"  />
